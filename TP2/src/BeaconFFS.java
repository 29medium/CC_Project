    ...
    public void run() {
        while(true) {
            try {
                ...
                pq.addFirst(new Packet(9, InetAddress.getLocalHost().getHostAddress(), ipGateway, 8888, portaGateway, Packet.getIdTransferenciaCounter(), -1, 1, "I'm Alive".getBytes(StandardCharsets.UTF_8)));
